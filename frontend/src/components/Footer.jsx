...
const Footer = () => {
  ...
  return (
    <footer className="flex items-center justify-between gap-4 py-6 border-t border-slate-200/80 dark:border-white/10 mt-auto transition-colors">
      ...
      <p className="flex-1 border-l border-slate-300 dark:border-white/20 pl-4 text-sm text-muted-foreground max-sm:hidden">
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          aria-label="Facebook"
          className="w-8.5 h-8.5 rounded-full flex items-center justify-center border border-slate-200/80 dark:border-white/10 text-muted-foreground hover:text-brand-blue dark:hover:text-cyan-300 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
        >
